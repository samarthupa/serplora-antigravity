        ...
        <div className="flex items-center space-x-1 sm:space-x-2">
          ...
          {(language === 'python' || language === 'py') && (
            <button 
              onClick={handleRun} 
              disabled={isRunning}
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-blue-600 bg-blue-500/10 hover:bg-blue-500/20 disabled:opacity-50 rounded-md transition-colors dark:text-green-400 dark:bg-green-400/10 dark:hover:bg-green-400/20"
            >
              {isRunning ? (
